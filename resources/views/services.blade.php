...
<div class="offers">
    ...
    <img class="offers__img-2" src="public/img/services/offers-img-2.png" alt="offers-img-2">
    <div class="container">
        ...
        <div class="offers__content">
            <div class="offers__wrap">
                ...
                <p class="offers__text"><span>*брендбук</span> – детальное руководство по использованию фирменного стиля
                     и маркетинговой платформы в виде презентации
                </p>
        ...
        <div class="products__content">
            ...
            <div class="products__list products__list_how">
                <div class="products__item">
                    ...
                    <div class="products__item-wrap">
                        <p class="products__item-text">Обсуждение задачи с клиентом, сроки, бюджет
            ...
            <div class="products__list products__list_stages">
                ...
                <div class="products__item">
                    ...
                    <div class="products__item-wrap">
                        <p class="products__item-text">Собираем брендбук с маркетинговой платформой и фирменным стилем
                        </p>
                    </div>
                </div>
            </div>
